...
const tierTemplates: TierTemplate = {
  '3rows': [
    ...
    {id: 'tier-a', name: 'A', items: [], labelPosition: 'left'},
    {id: 'tier-b', name: 'B', items: [], labelPosition: 'left'},
  ],
  '5rows': [
    {id: 'tier-s', name: 'S', items: [], labelPosition: 'left'},
    {id: 'tier-a', name: 'A', items: [], labelPosition: 'left'},
    {id: 'tier-b', name: 'B', items: [], labelPosition: 'left'},
    {id: 'tier-c', name: 'C', items: [], labelPosition: 'left'},
    {id: 'tier-f', name: 'F', items: [], labelPosition: 'left'},
  ],
  '7rows': [
    {id: 'tier-ss', name: 'SS', items: [], labelPosition: 'left'},
    {id: 'tier-s', name: 'S', items: [], labelPosition: 'left'},
    {id: 'tier-a', name: 'A', items: [], labelPosition: 'left'},
    {id: 'tier-b', name: 'B', items: [], labelPosition: 'left'},
    {id: 'tier-c', name: 'C', items: [], labelPosition: 'left'},
    {id: 'tier-d', name: 'D', items: [], labelPosition: 'left'},
    {id: 'tier-f', name: 'F', items: [], labelPosition: 'left'},
  ],
};
